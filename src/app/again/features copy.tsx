...
const Features = () => {
  ...
  useEffect(() => {
    ...
    // Animate the iPhone image (enhanced left-right motion)
    gsap.to(iphoneRef.current, {
      x: -100, // Move left
      y: 50, // Slightly move down
      rotation: -10, // Add a slight rotation
      ...
      scrollTrigger: {
        ...
        scrub: true, // Smoothly sync with scrolling
  ...
  return (
    <div ref={readyRef} className="grid grid-cols-2">
      ...
      <div className="relative">
        ...
        {/* Images Section */}
        <div className="relative h-[80vh] row-span-2 border-2 border-red-500">
          {/* Circles */}
          <div
            ref={circle1Ref}
          ...
          <Image
            ...
            height={100}
            width={100}
            className="w-full h-full absolute top-10 right-48 !z-1"
...
//     // Animate the iPhone image (left-right motion)
//     gsap.to(iphoneRef.current, {
...
// // //     gsap.to(iphoneRef.current, {
// // //       y: 100, // Move right as you scroll down
// // //       opacity: 1,
// // //       duration: 1,
// // //       scrollTrigger: {
// // //         trigger: "#iphone3",
