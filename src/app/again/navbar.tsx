...
//   return (
//     <div className="flex justify-between items-center pb-20 px-4">
//       <span className="flex justify-center items-center space-x-16">
//         <Image
//           src="/images/logo.svg"
//           alt="logo"
...
//         className={`fixed top-0 right-0 h-full w-full bg-white blur-lg shadow-lg transform ${
//           isMenuOpen ? 'translate-x-0' : 'translate-x-full'
//         } transition-transform duration-300 ease-in-out md:hidden z-50`}
//       >
//         <ul className="flex flex-col space-y-4 p-4 mt-16 !blur-0">
//           {['Home', 'About Us', 'Pricing', 'Features'].map((item) => (
//             <li
//               key={item}
//               onClick={() => handleItemClick(item)}
